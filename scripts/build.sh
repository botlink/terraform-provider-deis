...
DEST_BIN=terraform-provider-deis
...
echo ""
echo "Moving terraform-provider-deis_${XC_OS}_${XC_ARCH} to $DEST_PATH/$DEST_BIN"
echo ""

mv terraform-provider-deis_${XC_OS}_${XC_ARCH} $DEST_PATH/$DEST_BIN
